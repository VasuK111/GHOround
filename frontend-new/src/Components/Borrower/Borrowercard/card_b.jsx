...
import styles from "./card_b.module.css";
...
import Router_b from "../Router_b/Router/index";
...
function Card(){
        ...
        return (
          ...
          >
            <div className={styles.modalContainer}>
              <div className={styles.modalTitle}>Borrow model</div>
  ...
  const [optimiser, setOptimiser] = useState("");
    ...
    <div className={styles.card} >
        <h1 className={styles.cardTitle}>Heikinashi</h1>
        <p className={styles.cardSubtitle}>Heikin Ashi charts look similar to candlestick charts but are smoother because they track a range of price movements instead of every price movement.</p>
